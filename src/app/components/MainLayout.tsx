...
export function MainLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-500">
      ...
      {/* ================= FOOTER ================= */}
      <footer className="relative mt-24 overflow-hidden border-t border-accent/10 bg-neutral-950 pt-16 pb-12 text-neutral-400 sm:pt-20 sm:pb-16">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Main Footer Content */}
          <div className="mb-16 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1.2fr_0.9fr_0.9fr_1fr] lg:gap-12">
            {/* Brand Section */}
          ...
          {/* Bottom Bar */}
          <div className="flex flex-col items-center justify-between gap-6 border-t border-white/5 pt-10 text-center lg:flex-row lg:text-left">
            <div className="flex flex-wrap justify-center gap-5 text-[11px] font-black uppercase tracking-[0.18em] text-neutral-600 lg:justify-start sm:gap-8">
